...
// Updated fallback URL to specific project URL provided by user
const supabaseUrl = getEnv('VITE_SUPABASE_URL') || getEnv('REACT_APP_SUPABASE_URL') || 'https://lreetufzdmlrnfqzksul.supabase.co';
