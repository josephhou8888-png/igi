...
export const CalendarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
);
...
export const MOCK_USERS: User[] = [
  { id: 'admin-0', name: 'Admin User', email: 'admin@igipartnership.com', password: 'password', wallet: '0x...admin', rank: 9, uplineId: null, referralCode: 'ADMIN001', totalInvestment: 0, totalDownline: 0, monthlyIncome: 0, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Admin+User&background=random', country: 'System', isFrozen: false, role: 'admin', achievements: [], joinDate: '2022-12-01' },
  { id: 'user-1', name: 'Alex Johnson', email: 'alex@example.com', password: 'password', wallet: '0x...a1b2', rank: 5, uplineId: null, referralCode: 'ALEX123', totalInvestment: 25000, totalDownline: 260, monthlyIncome: 12500, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Alex+Johnson&background=random', country: 'USA', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-01-15' },
  { id: 'user-2', name: 'Maria Garcia', email: 'maria@example.com', password: 'password', wallet: '0x...c3d4', rank: 4, uplineId: 'user-1', referralCode: 'MARIA456', totalInvestment: 15000, totalDownline: 110, monthlyIncome: 7500, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Maria+Garcia&background=random', country: 'Spain', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-02-20' },
  { id: 'user-3', name: 'Chen Wei', email: 'chen@example.com', password: 'password', wallet: '0x...e5f6', rank: 4, uplineId: 'user-1', referralCode: 'CHEN789', totalInvestment: 18000, totalDownline: 95, monthlyIncome: 6800, kycStatus: 'Pending', avatar: 'https://ui-avatars.com/api/?name=Chen+Wei&background=random', country: 'China', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-03-10' },
  { id: 'user-4', name: 'Ben Carter', email: 'ben@example.com', password: 'password', wallet: '0x...g7h8', rank: 3, uplineId: 'user-2', referralCode: 'BEN101', totalInvestment: 8000, totalDownline: 40, monthlyIncome: 3200, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Ben+Carter&background=random', country: 'UK', isFrozen: true, role: 'user', achievements: [], joinDate: '2023-04-01' },
  { id: 'user-5', name: 'Sophia Loren', email: 'sophia@example.com', password: 'password', wallet: '0x...i9j0', rank: 3, uplineId: 'user-2', referralCode: 'SOPHIA22', totalInvestment: 9500, totalDownline: 50, monthlyIncome: 4100, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Sophia+Loren&background=random', country: 'Italy', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-05-18' },
  { id: 'user-6', name: 'Hiroshi Tanaka', email: 'hiroshi@example.com', password: 'password', wallet: '0x...k1l2', rank: 2, uplineId: 'user-3', referralCode: 'HIRO33', totalInvestment: 5000, totalDownline: 20, monthlyIncome: 1500, kycStatus: 'Rejected', avatar: 'https://ui-avatars.com/api/?name=Hiroshi+Tanaka&background=random', country: 'Japan', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-06-22' },
  { id: 'user-7', name: 'Fatima Al-Sayed', email: 'fatima@example.com', password: 'password', wallet: '0x...m3n4', rank: 1, uplineId: 'user-4', referralCode: 'FATIMA44', totalInvestment: 3000, totalDownline: 15, monthlyIncome: 600, kycStatus: 'Verified', avatar: 'https://ui-avatars.com/api/?name=Fatima+Al-Sayed&background=random', country: 'Egypt', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-08-11' },
  { id: 'user-8', name: 'Liam O\'Connell', email: 'liam@example.com', password: 'password', wallet: '0x...o5p6', rank: 1, uplineId: 'user-4', referralCode: 'LIAM55', totalInvestment: 3500, totalDownline: 12, monthlyIncome: 550, kycStatus: 'Not Submitted', avatar: 'https://ui-avatars.com/api/?name=Liam+O\'Connell&background=random', country: 'Ireland', isFrozen: false, role: 'user', achievements: [], joinDate: '2023-09-05' },
];
